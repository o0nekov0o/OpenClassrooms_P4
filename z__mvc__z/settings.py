from controller.rounds import RoundController
from controller.versus import VersusController
from models import tournament, player, rounds, versus
                ...
                if match_to_modify.resultat is not None:
                    ...
                    while choix_septies not in {"o", "n"}:
                        ...
                        if choix_septies == "o":
                            ...
                            VersusController().saisir_score(tournament, bdd)
            elif choix_quinquies == "n":
                edit_tournament_encode(tournament, bdd)
                RoundController().ajouter_tour(tournament, bdd)
